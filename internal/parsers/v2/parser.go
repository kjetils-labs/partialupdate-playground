...
func convertToType(val any, target reflect.Type) (any, error) {
	...
	// Helper: Convert a native Go value to the target type using reflection.
	// Used to "narrow" int64/uint64/float64 to specific types like int32.
	...
	default:
		// Fallback for other types (e.g. bool) or standard conversions
